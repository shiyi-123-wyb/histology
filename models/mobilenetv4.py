...
__all__ = ['mobilenetv4_conv_tiny', 'mobilenetv4_conv_medium', 'mobilenetv4_conv_large',
...
class UniversalInvertedBottleneck(nn.Module):
    def __init__(self, in_channels, out_channels, expand_ratio, start_dw_kernel_size, middle_dw_kernel_size,
                 stride, middle_dw_downsample=True, use_layer_scale=False, layer_scale_init_value=1e-5):
